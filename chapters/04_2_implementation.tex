...
Its intuitive design allows users to effortlessly scroll, zoom, and pan around plots, offering a dynamic exploration of the data. The ability to reset zoom provides added convenience, ensuring users can navigate through intricate details with ease.\\
...
Plotly offers great customization capabilities, particularly when interacting with data points through the hover feature. When hovering over data points, Plotly provides detailed information, including the value and index. This hover information undergoes filtering, where the resulting query number is sent to the corresponding data slice. 
...
\begin{figure}[h]
  ...
  \caption{Visualisation Item Wrapper Component provides a header with functionalities to each Plotly Component.}
